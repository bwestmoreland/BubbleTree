...
//        //// middleSepal Drawing
//        UIBezierPath* middleSepalPath = [UIBezierPath bezierPath];
//        [middleSepalPath moveToPoint: CGPointMake(133.77, 110.86)];
//        [middleSepalPath addCurveToPoint: CGPointMake(118.2, 112.32) controlPoint1: CGPointMake(126.36, 104.02) controlPoint2: CGPointMake(118.2, 112.32)];
//        [middleSepalPath addCurveToPoint: CGPointMake(113.39, 183.29) controlPoint1: CGPointMake(105.54, 125.35) controlPoint2: CGPointMake(105.5, 161.26)];
//        [middleSepalPath addCurveToPoint: CGPointMake(124.7, 119.2) controlPoint1: CGPointMake(105.92, 140.12) controlPoint2: CGPointMake(118.35, 124.29)];
//        [middleSepalPath addCurveToPoint: CGPointMake(127.32, 135.12) controlPoint1: CGPointMake(120.04, 123.97) controlPoint2: CGPointMake(121.61, 133.42)];
//        [middleSepalPath addCurveToPoint: CGPointMake(133.77, 110.86) controlPoint1: CGPointMake(137.79, 138.22) controlPoint2: CGPointMake(143.19, 119.56)];
//        [middleSepalPath closePath];
//        [middleSepalPath moveToPoint: CGPointMake(135.18, 126.38)];
//        [middleSepalPath addCurveToPoint: CGPointMake(135.79, 129.86) controlPoint1: CGPointMake(135.89, 127.73) controlPoint2: CGPointMake(136.15, 128.99)];
//        [middleSepalPath addCurveToPoint: CGPointMake(133.34, 130.82) controlPoint1: CGPointMake(135.44, 130.72) controlPoint2: CGPointMake(134.52, 131.02)];
//        [middleSepalPath addCurveToPoint: CGPointMake(132.03, 133.9) controlPoint1: CGPointMake(133.17, 132.48) controlPoint2: CGPointMake(132.72, 133.64)];
//        [middleSepalPath addCurveToPoint: CGPointMake(129.81, 132.14) controlPoint1: CGPointMake(131.34, 134.15) controlPoint2: CGPointMake(130.54, 133.46)];
//        [middleSepalPath addCurveToPoint: CGPointMake(127.34, 133.01) controlPoint1: CGPointMake(128.85, 133.14) controlPoint2: CGPointMake(127.95, 133.51)];
//        [middleSepalPath addCurveToPoint: CGPointMake(126.65, 129.56) controlPoint1: CGPointMake(126.72, 132.5) controlPoint2: CGPointMake(126.51, 131.23)];
//        [middleSepalPath addCurveToPoint: CGPointMake(124.47, 127.71) controlPoint1: CGPointMake(125.47, 129.32) controlPoint2: CGPointMake(124.65, 128.68)];
//        [middleSepalPath addCurveToPoint: CGPointMake(125.71, 124.59) controlPoint1: CGPointMake(124.29, 126.75) controlPoint2: CGPointMake(124.78, 125.62)];
//        [middleSepalPath addCurveToPoint: CGPointMake(125.1, 121.11) controlPoint1: CGPointMake(125, 123.24) controlPoint2: CGPointMake(124.74, 121.98)];
//        [middleSepalPath addCurveToPoint: CGPointMake(127.55, 120.15) controlPoint1: CGPointMake(125.46, 120.24) controlPoint2: CGPointMake(126.37, 119.95)];
//        [middleSepalPath addCurveToPoint: CGPointMake(128.86, 117.07) controlPoint1: CGPointMake(127.72, 118.48) controlPoint2: CGPointMake(128.18, 117.33)];
//        [middleSepalPath addCurveToPoint: CGPointMake(131.09, 118.83) controlPoint1: CGPointMake(129.55, 116.81) controlPoint2: CGPointMake(130.35, 117.5)];
//        [middleSepalPath addCurveToPoint: CGPointMake(133.55, 117.96) controlPoint1: CGPointMake(132.04, 117.83) controlPoint2: CGPointMake(132.94, 117.46)];
//        [middleSepalPath addCurveToPoint: CGPointMake(134.24, 121.41) controlPoint1: CGPointMake(134.17, 118.46) controlPoint2: CGPointMake(134.39, 119.74)];
//        [middleSepalPath addCurveToPoint: CGPointMake(136.42, 123.26) controlPoint1: CGPointMake(135.42, 121.65) controlPoint2: CGPointMake(136.24, 122.29)];
//        [middleSepalPath addCurveToPoint: CGPointMake(135.18, 126.38) controlPoint1: CGPointMake(136.61, 124.22) controlPoint2: CGPointMake(136.12, 125.34)];
//        [middleSepalPath closePath];
//        middleSepalPath.miterLimit = 4;
//        
//        [stemGreen setFill];
//        [middleSepalPath fill];
        
        
//        //// topSepal Drawing
//        UIBezierPath* topSepalPath = [UIBezierPath bezierPath];
//        [topSepalPath moveToPoint: CGPointMake(210.91, 86.75)];
//        [topSepalPath addCurveToPoint: CGPointMake(216.47, 66.22) controlPoint1: CGPointMake(218.42, 80.12) controlPoint2: CGPointMake(216.47, 66.22)];
//        [topSepalPath addCurveToPoint: CGPointMake(172.67, 30.45) controlPoint1: CGPointMake(213.34, 44.58) controlPoint2: CGPointMake(190.18, 29.55)];
//        [topSepalPath addCurveToPoint: CGPointMake(209.32, 71.66) controlPoint1: CGPointMake(203.65, 38.91) controlPoint2: CGPointMake(208.68, 61.42)];
//        [topSepalPath addCurveToPoint: CGPointMake(197.95, 68.38) controlPoint1: CGPointMake(208.19, 63.71) controlPoint2: CGPointMake(201.42, 61.78)];
//        [topSepalPath addCurveToPoint: CGPointMake(210.91, 86.75) controlPoint1: CGPointMake(191.58, 80.47) controlPoint2: CGPointMake(201.37, 95.17)];
//        [topSepalPath closePath];
//        [topSepalPath moveToPoint: CGPointMake(200.31, 82.08)];
//        [topSepalPath addCurveToPoint: CGPointMake(197.81, 81.41) controlPoint1: CGPointMake(199.15, 82.42) controlPoint2: CGPointMake(198.22, 82.23)];
//        [topSepalPath addCurveToPoint: CGPointMake(198.21, 77.87) controlPoint1: CGPointMake(197.4, 80.59) controlPoint2: CGPointMake(197.59, 79.3)];
//        [topSepalPath addCurveToPoint: CGPointMake(196.77, 74.91) controlPoint1: CGPointMake(197.21, 76.96) controlPoint2: CGPointMake(196.65, 75.9)];
//        [topSepalPath addCurveToPoint: CGPointMake(198.83, 72.8) controlPoint1: CGPointMake(196.89, 73.92) controlPoint2: CGPointMake(197.67, 73.19)];
//        [topSepalPath addCurveToPoint: CGPointMake(199.3, 69.28) controlPoint1: CGPointMake(198.59, 71.16) controlPoint2: CGPointMake(198.72, 69.86)];
//        [topSepalPath addCurveToPoint: CGPointMake(201.82, 69.84) controlPoint1: CGPointMake(199.88, 68.7) controlPoint2: CGPointMake(200.8, 68.96)];
//        [topSepalPath addCurveToPoint: CGPointMake(203.92, 67.82) controlPoint1: CGPointMake(202.47, 68.43) controlPoint2: CGPointMake(203.21, 67.65)];
//        [topSepalPath addCurveToPoint: CGPointMake(205.42, 70.71) controlPoint1: CGPointMake(204.62, 67.99) controlPoint2: CGPointMake(205.14, 69.09)];
//        [topSepalPath addCurveToPoint: CGPointMake(207.92, 71.38) controlPoint1: CGPointMake(206.58, 70.37) controlPoint2: CGPointMake(207.51, 70.56)];
//        [topSepalPath addCurveToPoint: CGPointMake(207.52, 74.91) controlPoint1: CGPointMake(208.33, 72.2) controlPoint2: CGPointMake(208.14, 73.49)];
//        [topSepalPath addCurveToPoint: CGPointMake(208.95, 77.88) controlPoint1: CGPointMake(208.52, 75.83) controlPoint2: CGPointMake(209.08, 76.89)];
//        [topSepalPath addCurveToPoint: CGPointMake(206.89, 79.99) controlPoint1: CGPointMake(208.83, 78.87) controlPoint2: CGPointMake(208.05, 79.6)];
//        [topSepalPath addCurveToPoint: CGPointMake(206.43, 83.51) controlPoint1: CGPointMake(207.14, 81.63) controlPoint2: CGPointMake(207, 82.93)];
//        [topSepalPath addCurveToPoint: CGPointMake(203.91, 82.95) controlPoint1: CGPointMake(205.84, 84.09) controlPoint2: CGPointMake(204.93, 83.83)];
//        [topSepalPath addCurveToPoint: CGPointMake(201.81, 84.97) controlPoint1: CGPointMake(203.26, 84.36) controlPoint2: CGPointMake(202.51, 85.14)];
//        [topSepalPath addCurveToPoint: CGPointMake(200.31, 82.08) controlPoint1: CGPointMake(201.11, 84.8) controlPoint2: CGPointMake(200.59, 83.7)];
//        [topSepalPath closePath];
//        topSepalPath.miterLimit = 4;
//        
//        [stemGreen setFill];
//        [topSepalPath fill];
...
//        //// bottomSepal Drawing
//        UIBezierPath* bottomSepalPath = [UIBezierPath bezierPath];
//        [bottomSepalPath moveToPoint: CGPointMake(145.61, 453.91)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(131.65, 463.76) controlPoint1: CGPointMake(136.89, 451.65) controlPoint2: CGPointMake(131.65, 463.76)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(146.78, 531.8) controlPoint1: CGPointMake(123.58, 482.68) controlPoint2: CGPointMake(133.44, 515.8)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(139.54, 466.55) controlPoint1: CGPointMake(128.01, 496.09) controlPoint2: CGPointMake(135.1, 474.71)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(146.35, 479.78) controlPoint1: CGPointMake(136.56, 473.48) controlPoint2: CGPointMake(140.62, 481.34)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(145.61, 453.91) controlPoint1: CGPointMake(156.85, 476.92) controlPoint2: CGPointMake(156.68, 456.78)];
//        [bottomSepalPath closePath];
//        [bottomSepalPath moveToPoint: CGPointMake(151.18, 467.44)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(152.7, 470.31) controlPoint1: CGPointMake(152.21, 468.29) controlPoint2: CGPointMake(152.8, 469.31)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(150.72, 472.53) controlPoint1: CGPointMake(152.61, 471.3) controlPoint2: CGPointMake(151.86, 472.07)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(150.35, 476.08) controlPoint1: CGPointMake(151.01, 474.16) controlPoint2: CGPointMake(150.92, 475.47)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(147.82, 475.68) controlPoint1: CGPointMake(149.79, 476.7) controlPoint2: CGPointMake(148.86, 476.5)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(145.79, 477.83) controlPoint1: CGPointMake(147.21, 477.12) controlPoint2: CGPointMake(146.49, 477.96)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(144.2, 475.03) controlPoint1: CGPointMake(145.08, 477.7) controlPoint2: CGPointMake(144.53, 476.64)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(141.68, 474.52) controlPoint1: CGPointMake(143.05, 475.45) controlPoint2: CGPointMake(142.12, 475.31)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(141.96, 470.96) controlPoint1: CGPointMake(141.25, 473.72) controlPoint2: CGPointMake(141.39, 472.43)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(140.44, 468.09) controlPoint1: CGPointMake(140.94, 470.11) controlPoint2: CGPointMake(140.35, 469.09)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(142.43, 465.87) controlPoint1: CGPointMake(140.53, 467.1) controlPoint2: CGPointMake(141.29, 466.33)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(142.8, 462.31) controlPoint1: CGPointMake(142.13, 464.24) controlPoint2: CGPointMake(142.23, 462.93)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(145.33, 462.72) controlPoint1: CGPointMake(143.36, 461.7) controlPoint2: CGPointMake(144.29, 461.9)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(147.36, 460.57) controlPoint1: CGPointMake(145.93, 461.28) controlPoint2: CGPointMake(146.66, 460.44)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(148.95, 463.37) controlPoint1: CGPointMake(148.07, 460.69) controlPoint2: CGPointMake(148.62, 461.75)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(151.47, 463.88) controlPoint1: CGPointMake(150.1, 462.95) controlPoint2: CGPointMake(151.03, 463.09)];
//        [bottomSepalPath addCurveToPoint: CGPointMake(151.18, 467.44) controlPoint1: CGPointMake(151.9, 464.67) controlPoint2: CGPointMake(151.76, 465.97)];
//        [bottomSepalPath closePath];
//        bottomSepalPath.miterLimit = 4;
//        
//        [stemGreen setFill];
//        [bottomSepalPath fill];
